            ...
            >
                ...
                >
                    <li className="header__item">
                        <NavLink className="header__link" to="/" onClick={ getClassActive}>
                            Home
                        </NavLink>
                    </li>

                    <li className="header__item  header__item_submenu" >
                        <NavLink to="/ourStories" className="header__link" onClick={() => setOpenSubmenu(!openSubmenu)}>
                            Our Stories
                            <span className={
                    ...
                    <li className="header__item">
                        <NavLink to="/contactsUs" className="header__link" onClick={getClassActive}>
                            Contact US
                        </NavLink>
                    </li>
                </ul>
